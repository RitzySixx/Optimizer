        ...
        switch ($selectedDNS) {
            "Google DNS" {
                foreach ($adapter in $adapters) {
                    ...
                    netsh interface ipv6 set dns name="$($adapter.Name)" static 2001:4860:4860::8888 primary
                    netsh interface ipv6 add dns name="$($adapter.Name)" 2001:4860:4860::8844 index=2
            ...
            "Cloudflare DNS" {
                foreach ($adapter in $adapters) {
                    ...
                    netsh interface ipv6 set dns name="$($adapter.Name)" static 2606:4700:4700::1111 primary
                    netsh interface ipv6 add dns name="$($adapter.Name)" 2606:4700:4700::1001 index=2
            ...
            "Default DNS" {
                foreach ($adapter in $adapters) {
                    ...
                    netsh interface ipv6 set dns name="$($adapter.Name)" dhcp
